...
export default function PostContentHeader({ coverImage, title }: PostWithUserType) {
  ...
  return (
    ...
    >
      <picture title={title} className='w-full transition-all aspect-[16/6] overflow-hidden cursor-zoom-in'>
