...
export default function CreateArticleFormActions({
    ...
    return (
        <section className='px-6 pt-4 flex flex-col gap-3 group' suppressHydrationWarning >
            {
                coverImagePreview &&
                <section className='w-full transition-all aspect-[16/6] mb-6 mt-2 overflow-hidden rounded-xl h-[150px]'>
