        ...
        <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 relative mb-28">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-4xl md:mb-20">
                ...
                <p className="text-base text-white md:text-lg">
                    <a className="underline" href="https://www.instagram.com/programadores_argentina/">@programadores_argentina</a> es una comunidad creada en 2018 con el proposito de generar un espacio
                    en común para programadores y personas del mundo IT en Argentina. 
                </p>
            </div>
            <div className="flex max-w-full gap-8 sm:mx-auto items-center">
                <div className="flex-[2] flex-col justify-center">
                    ...
                    <div className="flex">
                        ...
                        <div className="text-white">
                            ...
                            <p className="text-sm">
                                Contamos con una <a className="text-[#f9a853]" href="">Bolsa de talentos</a> donde podrás publicar tu perfil. Reclutadores y personas en
                                busqueda de programadores podrán encontrarte allí. Registrate y rellena el formulario para acceder.
                            </p>
                            <hr className="w-full my-6 border-gray-300" />
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-5 flex-[2]">
                    <img className="object-cover w-full h-56 col-span-2 rounded shadow-lg" src="/pictures/pic-3.jpeg" alt=""
                    style={{objectPosition: '0px 36%'}} />
                    <img className="object-cover w-full h-56 col-span-2 rounded shadow-lg" src="/pictures/pic-2.jpeg" alt=""
