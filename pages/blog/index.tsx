...
import authorImage from "../../public/LogoProgramadoresArgentina.png";
	...
	<div className="w-full min-h-screen blog inline-block">
		<div className="blog-header">
            ...
            <div className="content">
                ...
                <h2>&quot; Toda línea de código tiene su historia &quot;</h2>
                        ...
                        <li key={i}>
                            ...
                            <div className="articles-content">
                                ...
                                <div className="article-author">
                                    <div className="article-author-image bg-background-blog-world" >
                                    </div>
