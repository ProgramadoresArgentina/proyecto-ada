    ...
    switch (method) {
        case "GET":
           try{
            ...
            res.status(200).json({message: `USER SETTINGS WITH ID: ${query.id} NOT FOUND`})
        }
        break;
        ...
        case "PUT":
            try{
                ...
                res.status(200).json({message : "ERROR TRYING TO UPDATE USER SETTINGS"});
            }
            break;
        ...
        case "DELETE":
            try{
                ...
                res.status(200).json({message: "ERROR TRYING TO DELETE USER SETTINGS"})
            }   
            break;
        default:
