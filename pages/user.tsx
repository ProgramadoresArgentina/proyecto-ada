...
const User: NextPage = () => {
    ...
    return (
        ...
        >
        {({ errors, isValid }) => (
            <Form className="mx-auto mt-16 px-5 sm:w-3/4 lg:px-0 lg:max-w-3xl lg:w-1/3 sm:mt-20">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="flex items-center left-2 text-white">
                            <label className="text-sm">https://programadoresargentina.com/pro/</label>
                        </div>
